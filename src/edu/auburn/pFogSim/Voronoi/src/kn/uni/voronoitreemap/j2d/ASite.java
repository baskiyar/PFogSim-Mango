...
public PolygonSimple getNonClippedPolyon() {
	return nonClippedPolyon;
}


public void setNonClippedPolyon(PolygonSimple nonClippedPolyon) {
	this.nonClippedPolyon = nonClippedPolyon;
}
