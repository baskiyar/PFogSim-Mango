function [] = plotAvgCost()
    ...
    plotGenericResult(1, 9, {'Average Cost ($)'}, 'REMOTE_HEALTHCARE', 0, 'REMOTE HEALTHCARE');
    %plotGenericResult(1, 9, {'Average Cost ($)'}, 'COGNITIVE_ASSISTANCE', 0, 'COGNITIVE ASSISTANCE');
    %plotGenericResult(1, 9, {'Average Cost ($)'}, 'AUGMENTED_REALITY', 0, 'AUGMENTED REALITY');
