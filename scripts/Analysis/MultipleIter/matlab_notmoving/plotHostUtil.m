function [] = plotHostUtil()

    %plotGenericResult(4, 4, 'Average No. of Messages', 'ALL_APPS', 0);
    stacked_histgraph(6000, 6, 'REMOTE_HEALTHCARE', 'REMOTE HEALTHCARE', 'Avg. Host Util % per fog layer');
    %stacked_histgraph(6000, 6, 'AUGMENTED_REALITY', 'AUGMENTED REALITY', 'Avg. Host Util % per fog layer');
