...
function [ret_val] = getConfiguration(argType)
    if(argType == 1)
        ...
        ret_val = 'C:\Users\cvc0012\Desktop\PFogSim\sim_results\ite2';
    ...
    elseif(argType == 5)
        ...
        ret_val = {'LOCAL_ONLY','HAFA_ORCHESTRATOR'};   
    elseif(argType == 6)
    ...
    elseif(argType == 9)
        ret_val = 'No. of devices'; %Common text for s axis
    elseif(argType == 10)
        ret_val = 100; %min number of mobile device
    elseif(argType == 11)
        ret_val = 100; %step size of mobile device count
    elseif(argType == 12)
        ret_val =200; %max number of mobile device
    elseif(argType == 19)
